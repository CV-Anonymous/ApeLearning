...
def train(cfg):
    ...
    if cfg.MODEL.IF_WITH_CENTER == 'no':
        ...
        if cfg.MODEL.METRIC_LOSS_TYPE == 'ours' or cfg.MODEL.METRIC_LOSS_TYPE == 'ours_triplet':
            ourloss, loss_func = make_loss(cfg, num_classes)  # modified by gu
            optimizer = make_optimizer(cfg, model, ourloss)
        else:
...
def main():
    ...
    logger = setup_logger("reid_baseline", output_dir, 0, cfg.LOG_NAME)
